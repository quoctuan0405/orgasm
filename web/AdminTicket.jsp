        ...
        <div class="post-body">
            ...
            <div class="main">
                <div class="box">
                    ...
                    <div class="search">
                        <form action="searchTicket" method="post" class="searchMethod">
                            <div>
                    ...
                    <c:if test="${sessionScope.acc != null}">
                        <div class="management">
                            ...
                            <ul>
                                <li class="my-ports">
                                    <a href="${pageContext.request.contextPath}/ticketadmin">User Ticket</a>
                                </li>
                            </ul>
                        </div>
                    </c:if>
            ...
            <div class="post-tag">  
                ...
                <div class="pagination row">
                    <c:forEach begin="1" end="${endPage}" var="o">
                        <a href="ticketadmin?page=${o}" <c:if test="${currentPage == o}">class="current"</c:if>>${o}</a>
                    </c:forEach>
                </div>
