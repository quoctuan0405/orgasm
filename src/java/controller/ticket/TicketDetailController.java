 ...
 * @author LAPTOP D&N
 */
@WebServlet(name = "TicketDetailController", urlPatterns = {"/ticketdetail"})
public class TicketDetailController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet TicketDetailController</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet TicketDetailController at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Ticket ticketdetail = Tickets.getTicketByID(id);
            List<TicketComment> ticketcomment = Tickets.getCommentByTicketId(id);
            List<BlogCategory> listBlogCategory = BlogCategories.all();
            
            request.setAttribute("ticketdetail", ticketdetail);
            request.setAttribute("ticketcomment", ticketcomment);
